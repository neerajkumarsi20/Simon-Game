...
function checkAnswer(currentLevel) {
    ...
    if (gamePattern[currentLevel] === userClickedPattern[currentLevel]) {
      ...
      $("#current-score").textContent = level
      setTimeout(function () {
...
var highScore = localStorage.getItem("highScore") || 0; // Retrieve high score
$("#high-score").text("High Score: " + highScore); // Display high score

function updateScore() {
    var current_score = level - 1;
    ...
    if ((level - 1) > highScore) {
        ...
        $("#high-score-message").text("🎉 New High Score! 🎉").fadeIn().delay(2000).fadeOut();
    }
}
